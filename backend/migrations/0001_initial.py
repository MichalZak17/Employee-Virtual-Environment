# Generated by Django 5.0 on 2023-12-26 00:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team_project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.projects')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('user_team', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.teams')),
            ],
            options={
                'verbose_name': 'user',
